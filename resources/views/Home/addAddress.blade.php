...
<body class="bg-gray-50">
    ...
    <main class="container mx-auto px-4 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 space-x-reverse">
                ...
                <li>
                  ...
                  <li>
                    <div class="flex items-center">
                        <i data-feather="chevron-left" class="w-4 h-4 text-gray-400"></i>
                        <span class="mr-2 text-blue-600 font-medium">افزودن آدرس جدید </span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <form action="{{route('Home.Profile.addAdress')}}" method="POST">
                @csrf
                <!-- تب اطلاعات حساب (پیش‌فرض فعال) -->
                <div id="profile" class="tab-content active">
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="text-2xl font-bold text-gray-800"> اضافه کردن آدرس</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2"> شهر </label>
                                    <input type="text" name="city" value="" id="" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 " >
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">کد پستی</label>

                                    <input type="text" name="postal_code" value="" id="" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 " >

                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">آدرس </label>
                                    <input type="text" name="address" value="" id="" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-500 " >
                            </div>
